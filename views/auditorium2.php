    ...
    >
      ...
      <a-entity id="menu" video>
        <a-curvedimage
          ...
          radius="6"
          height="2.75"
          position="-1.2 1.9 0.8"
          theta-length="59"
          rotation="0 150 0"
          animation__scale="property: position; to: -1.2 1.9 1.3; dur: 200; startEvents: mouseenter"
          animation__scale_reverse="property: position; to: -1.2 1.9 0.8; dur: 200; startEvents: mouseleave"
